      ...
      <section className="pt-28 pb-20 px-6 bg-black min-h-[70vh] flex items-center justify-center">
        <div className="max-w-lg mx-auto text-center">
          ...
          <h2 className="text-3xl font-semibold text-white mb-4">
            Booking <span className="text-gradient-pink">Confirmed!</span>
          </h2>
          ...
          <button
            ...
            className="px-8 py-3 border border-pink/30 text-pink tracking-wider uppercase text-sm hover:bg-pink/10 transition-all duration-300 rounded-sm"
          >
            Book Another
          </button>
        </div>
